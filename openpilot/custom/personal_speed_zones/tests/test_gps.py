...
def message(sequence=10_000_000_000, valid=True, fix=True, horizontal=2.0, bearing_accuracy=5.0):
  ...
  return SimpleNamespace(valid=valid, logMonoTime=sequence, which=lambda: "gpsLocation", gpsLocation=location)
